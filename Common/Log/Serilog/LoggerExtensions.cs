...
public static class LoggerExtensions
{
    ...
    public static void ConditionalDebug(
        ...
        [CallerLineNumber] int callerLineNumber = 0)
    {
        if (condition) CustomLog(logger, message, LogEventLevel.Debug, callerMemberName, callerFilePath, callerLineNumber);
    }
    ...
    public static void ConditionalInfo(
        ...
        [CallerLineNumber] int callerLineNumber = 0)
    {
        if (condition) CustomLog(logger, message, LogEventLevel.Information, callerMemberName, callerFilePath, callerLineNumber);
    }
    ...
    public static void ConditionalError(
        ...
        [CallerLineNumber] int callerLineNumber = 0)
    {
        if (condition) CustomLog(logger, message, LogEventLevel.Error, callerMemberName, callerFilePath, callerLineNumber);
    }
    ...
    public static void ConditionalFatal(
        ...
        [CallerLineNumber] int callerLineNumber = 0)
    {
        if (condition) CustomLog(logger, message, LogEventLevel.Fatal, callerMemberName, callerFilePath, callerLineNumber);
    }
        ...
        int callerLineNumber = 0)
    {
        ...
        if (level == LogEventLevel.Fatal) throw new System.Exception($"Fatal error: {message}");
    }
